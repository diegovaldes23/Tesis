...
=============================================================================
  ...
  Configuración LoRA (calibrada sobre I3D):
    rank=4 | alpha=8 | lora_dropout=0.10
...
T           = 32
IMG_SIZE    = 224
NUM_WORKERS = 6       # más workers → DataLoader no bottleneckea la GPU
...
if __name__ == "__main__":
    ...
    print(f"  LoRA: r=4 | α=8 | dropout=0.10 | target=MLP-fc(FFN) | lr=1e-4")
